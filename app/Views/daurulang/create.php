...
<div class="col-sm-12 col-lg-12 pt-5 mb-5 pb-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" action="<?= base_url('/daur_ulang/save'); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="nama_donasi" class="form-label">nama donasi</label>
                        <input type="text" class="form-control" id="nama_donasi" name="nama_donasi" rows="3"><?= old('nama_donasi'); ?>
                    </div>
                    <div class="mb-3">
